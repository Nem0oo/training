...
const SETTINGS_PATHS = ['/parametres', '/vma', '/fc-zones']
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 bg-slate-900 border-t border-slate-700 safe-b">
      <div className="flex items-center justify-around h-16 max-w-lg mx-auto px-4">
        ...
        <NavLink
          to="/parametres"
          className={`flex flex-col items-center gap-0.5 text-xs font-medium transition-colors ${settingsActive ? 'text-orange-400' : 'text-slate-400 hover:text-slate-200'}`}
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
